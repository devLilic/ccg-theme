    ...
    <div class="container mx-auto px-4">
        ...
        <section class="mb-10 bg-white rounded-2xl shadow-sm border border-slate-200 p-4 md:p-5">
            <form method="get" class="grid gap-3 md:grid-cols-4 lg:grid-cols-6 items-end">
                ...
                <div>
                    ...
                    <select name="target_audience" class="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm">
                ...
                <div>
                    ...
                    <select name="date_filter" class="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm">
                        ...
                        <option value="weekend" <?php selected( $selected_date, 'weekend' ); ?>>Weekend-ul acesta</option>
        ...
        <?php if ( have_posts() ) : ?>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                while ( have_posts() ) :
                    the_post();
                    get_template_part( 'template-parts/events/card', 'event', [ 'post_id' => get_the_ID() ] );
                endwhile;
                ?>
            </div>
        ...
        <?php else : ?>
            ...
            <div class="text-center py-20">
                <h2 class="text-2xl font-bold text-slate-800 mb-4">Momentan nu sunt evenimente în această categorie.</h2>
